                        ...
                        dbc.Col(
                            ...
                            children=[
                                dcc.Dropdown(
                                    id='date_menu',
                                    options=[
                                        {'label': pd.to_datetime(timestamp).strftime('%Y.%m.%d'), 'value': timestamp}
                                        for
...
tabs = dbc.Tabs(
    children=[
        dbc.Tab(tab1_content, label="Overview", tab_style={"height": "50px", "background-color": "white"},
                                    ...
                                    children=[
                                        dbc.Row(children=[
                                            dbc.Col(
                                                dcc.Dropdown(
                                                    id='airport_menu',
                                                    options=[{'label': IATA, 'value': IATA} for IATA in
                                                             airports_info["IATA_CODE"]],
...
def update_infobox(selectedData, date, inputData):
    if date:
        ...
        if not inputData:
            ...
            fig.update_layout(
                title="Departure Delay Number & Length Distribution at {}-{} Nationwide".format(timestamp.month,
                                                                                                timestamp.day))
            obj = dcc.Graph(
                figure=fig,
                ...
                children=[
                    dbc.Row(
                        style={'padding-left': '3%', 'padding-right': '3%', 'padding-top': '1%',
                               "position": "relative"},
                        children=[
                            html.P(["Airport Name: {}\n".format(infos["AIRPORT"].values[0]), html.Br(),
                                    "City Name: {}\n".format(infos["CITY"].values[0]),
                                    html.Br(), "Total Flights of Today: {}\n".format(total_flights)],
                                   style={'fontFamily': 'Arial', 'color': '#525252'})]
                    ),
                    dbc.Row([html.P([
                                        "Departure Delay Length Distribution of Flights From {} To Hottest Destinations".format(
                                            airport)],
                                    style={"text-align": "center", "position": "relative", "padding-left": "8%",
                                           "padding-right": "8%", "width": "100%", "height": "100%"})]
                    ...
                    dbc.Row(
                        ...
                        children=[
                            ...
                            dbc.Col([dcc.Graph(figure=fig, clear_on_unhover=True, id="stacked_bar",
                                    ...
                                    style={'padding-left': '3%', 'padding-right': '0%', "position": "relative",
                                           "height": "90%", "width": "50%"},
                                    # width={"size":"100%"}
                                    ),  # 410
                            dbc.Col(
                                ...
                                style={'padding-left': '0%', 'padding-right': '0%', 'padding-bottom': '3%',
